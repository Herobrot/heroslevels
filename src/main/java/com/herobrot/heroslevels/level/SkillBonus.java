...
public record SkillBonus(String key, int id, int level) {
    public static final List<String> BONUS_KEYS = List.of(
            "bowDamage", "bowDoubleDamageChance", "crossbowDamage", "crossbowDoubleDamageChance",
            "itemDamageChance", "potionAmplifierChanceBonus", "potionDurationBonus", "lingeringCloudRadiusChanceBonus",
            "lingeringCloudRadiusBonus", "lingeringCloudDurationBonus", "breedTwinChance", "fallDamageReduction",
            "deathGraceChance", "tntStrength", "priceDiscount", "tradeXp", "merchantImmune", "miningDropChance",
            "plantDropChance", "anvilXpCap", "anvilXpDiscount", "anvilXpChance", "healthRegen",
            "healthAbsorption", "exhaustionReduction", "meleeKockbackAttackChance", "meleeCriticalAttackChance",
            "meleeCriticalAttackDamage", "meleeDoubleAttackDamageChance", "foodIncreasion", "damageReflection",
